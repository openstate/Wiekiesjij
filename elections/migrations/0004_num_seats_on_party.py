...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.num_seats'
        db.add_column('elections_party', 'num_seats', orm['elections.party:num_seats'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Party.num_seats'
        db.delete_column('elections_party', 'num_seats')
