...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.manifesto_summary'
        db.add_column('elections_party', 'manifesto_summary', orm['elections.party:manifesto_summary'])
        
        # Deleting field 'Party.manifasto_summary'
        db.delete_column('elections_party', 'manifasto_summary')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Party.manifesto_summary'
        db.delete_column('elections_party', 'manifesto_summary')
        
        # Adding field 'Party.manifasto_summary'
        db.add_column('elections_party', 'manifasto_summary', orm['elections.party:manifasto_summary'])
    ...
    models = {
        ...
        'elections.party': {
            ...
            'manifesto': ('django.db.models.fields.URLField', [], {'max_length': '2550', 'null': 'True', 'blank': 'True'}),
            'manifesto_summary': ('django.db.models.fields.CharField', [], {'max_length': '2550', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
