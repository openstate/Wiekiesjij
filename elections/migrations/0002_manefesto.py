...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Party.manifesto'
        # (to signature: django.db.models.fields.URLField(max_length=2550, null=True, blank=True))
        db.alter_column('elections_party', 'manifesto', orm['elections.party:manifesto'])
        
        # Changing field 'Party.manifasto_summary'
        # (to signature: django.db.models.fields.CharField(max_length=2550, null=True, blank=True))
        db.alter_column('elections_party', 'manifasto_summary', orm['elections.party:manifasto_summary'])
    ...
    models = {
        ...
        'elections.party': {
            ...
            'manifasto_summary': ('django.db.models.fields.CharField', [], {'max_length': '2550', 'null': 'True', 'blank': 'True'}),
