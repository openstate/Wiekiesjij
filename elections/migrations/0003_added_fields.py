...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.address_city'
        db.add_column('elections_party', 'address_city', orm['elections.party:address_city'])
        
        # Adding field 'Party.address_number'
        db.add_column('elections_party', 'address_number', orm['elections.party:address_number'])
        
        # Adding field 'Party.address_street'
        db.add_column('elections_party', 'address_street', orm['elections.party:address_street'])
        
        # Adding field 'Party.address_postalcode'
        db.add_column('elections_party', 'address_postalcode', orm['elections.party:address_postalcode'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Party.address_city'
        db.delete_column('elections_party', 'address_city')
        
        # Deleting field 'Party.address_number'
        db.delete_column('elections_party', 'address_number')
        
        # Deleting field 'Party.address_street'
        db.delete_column('elections_party', 'address_street')
        
        # Deleting field 'Party.address_postalcode'
        db.delete_column('elections_party', 'address_postalcode')
