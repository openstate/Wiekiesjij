...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CouncilEvent.sent_datetime'
        db.add_column('elections_councilevent', 'sent_datetime', orm['elections.councilevent:sent_datetime'])
        
        # Adding field 'Council.credit'
        db.add_column('elections_council', 'credit', orm['elections.council:credit'])
        
        # Adding field 'Council.credit_warning'
        db.add_column('elections_council', 'credit_warning', orm['elections.council:credit_warning'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'CouncilEvent.sent_datetime'
        db.delete_column('elections_councilevent', 'sent_datetime')
        
        # Deleting field 'Council.credit'
        db.delete_column('elections_council', 'credit')
        
        # Deleting field 'Council.credit_warning'
        db.delete_column('elections_council', 'credit_warning')
