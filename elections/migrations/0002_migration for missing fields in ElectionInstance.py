...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ElectionInstance.num_lists'
        db.add_column('elections_electioninstance', 'num_lists', orm['elections.electioninstance:num_lists'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ElectionInstance.num_lists'
        db.delete_column('elections_electioninstance', 'num_lists')
