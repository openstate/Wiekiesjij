...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.rename_column('elections_electionevent', 'desciption', 'description')
        db.rename_column('elections_council', 'desciption', 'description')
        
    
    
    def backwards(self, orm):

        db.rename_column('elections_electionevent', 'description', 'desciption')
        db.rename_column('elections_council', 'description', 'desciption')
