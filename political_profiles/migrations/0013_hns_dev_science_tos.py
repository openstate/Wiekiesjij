...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PoliticianProfile.hns_dev'
        db.add_column('political_profiles_politicianprofile', 'hns_dev', orm['political_profiles.politicianprofile:hns_dev'])
        
        # Adding field 'PoliticianProfile.science'
        db.add_column('political_profiles_politicianprofile', 'science', orm['political_profiles.politicianprofile:science'])
        
        # Adding field 'ContactProfile.terms_and_conditions'
        db.add_column('political_profiles_contactprofile', 'terms_and_conditions', orm['political_profiles.contactprofile:terms_and_conditions'])
        
        # Adding field 'PoliticianProfile.terms_and_conditions'
        db.add_column('political_profiles_politicianprofile', 'terms_and_conditions', orm['political_profiles.politicianprofile:terms_and_conditions'])
        
        # Adding field 'ChanceryProfile.terms_and_conditions'
        db.add_column('political_profiles_chanceryprofile', 'terms_and_conditions', orm['political_profiles.chanceryprofile:terms_and_conditions'])
        
        # Adding field 'VisitorProfile.terms_and_conditions'
        db.add_column('political_profiles_visitorprofile', 'terms_and_conditions', orm['political_profiles.visitorprofile:terms_and_conditions'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'PoliticianProfile.hns_dev'
        db.delete_column('political_profiles_politicianprofile', 'hns_dev')
        
        # Deleting field 'PoliticianProfile.science'
        db.delete_column('political_profiles_politicianprofile', 'science')
        
        # Deleting field 'ContactProfile.terms_and_conditions'
        db.delete_column('political_profiles_contactprofile', 'terms_and_conditions')
        
        # Deleting field 'PoliticianProfile.terms_and_conditions'
        db.delete_column('political_profiles_politicianprofile', 'terms_and_conditions')
        
        # Deleting field 'ChanceryProfile.terms_and_conditions'
        db.delete_column('political_profiles_chanceryprofile', 'terms_and_conditions')
        
        # Deleting field 'VisitorProfile.terms_and_conditions'
        db.delete_column('political_profiles_visitorprofile', 'terms_and_conditions')
