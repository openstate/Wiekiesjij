...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PoliticianProfile.work_experience_days'
        db.add_column('political_profiles_politicianprofile', 'work_experience_days', orm['political_profiles.politicianprofile:work_experience_days'])
        
        # Adding field 'PoliticianProfile.political_experience_days'
        db.add_column('political_profiles_politicianprofile', 'political_experience_days', orm['political_profiles.politicianprofile:political_experience_days'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'PoliticianProfile.work_experience_days'
        db.delete_column('political_profiles_politicianprofile', 'work_experience_days')
        
        # Deleting field 'PoliticianProfile.political_experience_days'
        db.delete_column('political_profiles_politicianprofile', 'political_experience_days')
