...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PoliticianProfile.hobby'
        # (to signature: django.db.models.fields.CharField(max_length=255, null=True, blank=True))
        db.alter_column('political_profiles_politicianprofile', 'hobby', orm['political_profiles.politicianprofile:hobby'])
        
        # Changing field 'PoliticianProfile.fav_sport'
        # (to signature: django.db.models.fields.CharField(max_length=255, null=True, blank=True))
        db.alter_column('political_profiles_politicianprofile', 'fav_sport', orm['political_profiles.politicianprofile:fav_sport'])
        
        # Changing field 'PoliticianProfile.charity'
        # (to signature: django.db.models.fields.CharField(max_length=255, null=True, blank=True))
        db.alter_column('political_profiles_politicianprofile', 'charity', orm['political_profiles.politicianprofile:charity'])
        
        # Changing field 'PoliticianProfile.fav_club'
        # (to signature: django.db.models.fields.CharField(max_length=255, null=True, blank=True))
        db.alter_column('political_profiles_politicianprofile', 'fav_club', orm['political_profiles.politicianprofile:fav_club'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PoliticianProfile.religious_group'
        db.delete_column('political_profiles_politicianprofile', 'religious_group')
        
        # Deleting field 'PoliticianProfile.religion'
        db.delete_column('political_profiles_politicianprofile', 'religion')
        ...
        # Changing field 'PoliticianProfile.hobby'
        # (to signature: django.db.models.fields.CharField(max_length=25, null=True, blank=True))
        db.alter_column('political_profiles_politicianprofile', 'hobby', orm['political_profiles.politicianprofile:hobby'])
        ...
        # Changing field 'PoliticianProfile.charity'
        # (to signature: django.db.models.fields.CharField(max_length=35, null=True, blank=True))
        db.alter_column('political_profiles_politicianprofile', 'charity', orm['political_profiles.politicianprofile:charity'])
