...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PoliticianProfile.motivation'
        db.delete_column('political_profiles_politicianprofile', 'motivation')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'PoliticianProfile.motivation'
        db.add_column('political_profiles_politicianprofile', 'motivation', orm['political_profiles.politicianprofile:motivation'])
