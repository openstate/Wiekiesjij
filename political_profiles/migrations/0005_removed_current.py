...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WorkExperience.current'
        db.delete_column('political_profiles_workexperience', 'current')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'WorkExperience.current'
        db.add_column('political_profiles_workexperience', 'current', orm['political_profiles.workexperience:current'])
