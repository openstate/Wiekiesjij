...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PoliticianProfile.motivation'
        # (to signature: django.db.models.fields.CharField(max_length=45, null=True, blank=True))
        db.alter_column('political_profiles_politicianprofile', 'motivation', orm['political_profiles.politicianprofile:motivation'])
