...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VisitorResult.sent'
        db.add_column('frontoffice_visitorresult', 'sent', orm['frontoffice.visitorresult:sent'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'VisitorResult.sent'
        db.delete_column('frontoffice_visitorresult', 'sent')
