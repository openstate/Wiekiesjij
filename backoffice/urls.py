...
urlpatterns += patterns('backoffice.views',
    ...
    url(r'^council/edit/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/$', 'council_edit', name='backoffice.council_edit'),
    url(r'^council/edit/done$', 'council_edit_done', name='backoffice.council_edit_done'),
