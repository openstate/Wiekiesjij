...
urlpatterns = patterns('',
  ...
  url(r'^forgot-password/confirm/(?P<uidb36>.+)/(?P<token>.+)/$', 'django.contrib.auth.views.password_reset_confirm', {
        'template_name': 'backoffice/forgot_password_confirm.html'
        }, name='bo.password_confirm'),
...
urlpatterns += patterns('backoffice.views',
    ...
    url(r'^welcome/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/work/edit/(?P<work_id>\d+)$', 'politician_profile_work_wizard', name='bo.politician_profile_work_wizard_edit'),
    url(r'^welcome/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/work/delete/(?P<work_id>\d+)$', 'politician_profile_work_delete', name='bo.politician_profile_work_delete'),
    ...
    url(r'^welcome/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/political/delete/(?P<political_id>\d+)$', 'politician_profile_political_delete', name='bo.politician_profile_political_delete'),
    ...
    url(r'^welcome/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/interest/delete/(?P<interest_id>\d+)$', 'politician_profile_interest_delete', name='bo.politician_profile_interest_delete'),
    ...
    url(r'^welcome/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/appearance/delete/(?P<appearance_id>\d+)$', 'politician_profile_appearance_delete', name='bo.politician_profile_appearance_delete'),
    ...
    url(r'^welcome/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/education/delete/(?P<education_id>\d+)$', 'politician_profile_education_delete', name='bo.politician_profile_education_delete'),
    ...
    url(r'^welcome/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/links/delete/(?P<link_id>\d+)$', 'politician_profile_link_delete', name='bo.politician_profile_link_delete'),

    url(r'^welcome/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/connections/$', 'politician_profile_connection', name='bo.politician_profile_connection'),
    url(r'^welcome/(?P<election_instance_id>\d+)/(?P<user_id>\d+)/connections/add/$', 'politician_profile_connection_wizard', name='bo.politician_profile_connection_wizard'),
