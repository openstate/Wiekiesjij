...
QTYPE_NORM_POLMULTICHOICE_VISMULTICHOICE_MIN_THREE = 'K'
...
MULTIPLE_ANSWER_TYPES = (QTYPE_MODEL_POLITICAL_EXPERIENCE_TYPE, QTYPE_MODEL_WORK_EXPERIENCE_TYPE, QTYPE_MODEL_PROFILE_RELIGION, QTYPE_MODEL_PARTY, QTYPE_NORM_POLMULTICHOICE_VISMULTICHOICE, QTYPE_MODEL_POLONECHOICE_VISMULTICHOICE, QTYPE_MODEL_POLMULTICHOICE_VISMULTICHOICE, QTYPE_NORM_POLMULTICHOICE_VISMULTICHOICE_MIN_THREE)
# Question types to show to the candidate
BACKOFFICE_QUESTION_TYPES = (QTYPE_MODEL_POLMULTICHOICE_VISMULTICHOICE, QTYPE_NORM_POLONECHOICE_VISONECHOICE_RANGE, QTYPE_NORM_POLONECHOICE_VISONECHOICE, QTYPE_NORM_POLMULTICHOICE_VISMULTICHOICE, QTYPE_NORM_POLBOOL_VISBOOL, QTYPE_NORM_POLMULTICHOICE_VISMULTICHOICE_MIN_THREE)
