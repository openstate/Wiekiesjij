...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PoliticianProfile.position_within_party'
        db.add_column('political_profiles_politicianprofile', 'position_within_party', self.gf('django.db.models.fields.CharField')(default='MIDDLE', max_length=255), keep_default=False)

        # Adding field 'PoliticianProfile.own_campaign'
        db.add_column('political_profiles_politicianprofile', 'own_campaign', self.gf('django.db.models.fields.CharField')(default='NO', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PoliticianProfile.position_within_party'
        db.delete_column('political_profiles_politicianprofile', 'position_within_party')

        # Deleting field 'PoliticianProfile.own_campaign'
        db.delete_column('political_profiles_politicianprofile', 'own_campaign')
    ...
    models = {
        ...
        'political_profiles.politicianprofile': {
            ...
            'own_campaign': ('django.db.models.fields.CharField', [], {'default': "'NO'", 'max_length': '255'}),
            'picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'political_experience_days': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'position_within_party': ('django.db.models.fields.CharField', [], {'default': "'MIDDLE'", 'max_length': '255'}),
