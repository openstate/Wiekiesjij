...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        q10_answers = [
            "Een betere wereld",
            "Een sterker en beter Nederland",
            "Het versterken van zijn/haar regio",
            "Een krachtige partij",
            "Persoonlijke ontplooiing",
            "Anders",
        ]
        for position, answer in enumerate(q10_answers):
            Answer.objects.create(
                question=q10,
                value=answer,
                frontoffice_value=None,
        ...
        q12_answers = [
            "Religie is leidend voor zijn/haar politiek handelen",
            "Religie is inspiratiebron voor zijn/haar politiek handelen",
            "Religie inspireert hem/haar persoonlijk",
            "Religie speelt voor hem/haar geen rol",
        ]
        for position, answer in enumerate(q12_answers):
            Answer.objects.create(
                question=q12,
                value=answer,
                frontoffice_value=None,
