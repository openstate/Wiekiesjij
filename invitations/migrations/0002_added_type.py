...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.type'
        db.add_column('invitations_invitation', 'type', orm['invitations.invitation:type'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Invitation.type'
        db.delete_column('invitations_invitation', 'type')
